...
# filename = 'D:\Dropbox\Purdue_work\ML\Qubit_readout\SVC_classifier_v1.joblib.pkl'
# _ = joblib.dump(classifier, filename, compress=0)

# pickle.dump(model, open(filename, 'wb'))
#%%
# training a KNN classifier 
from sklearn.neighbors import KNeighborsClassifier 
knn = KNeighborsClassifier(n_neighbors = 20,algorithm='kd_tree',p=2,weights = 'uniform').fit(X_train, Y_train) 
...
filename = 'knn_classifier_v2.joblib.pkl'
_ = joblib.dump(knn, filename, compress=0)
...
filename = 'dtree_classifier_v1.joblib.pkl'
_ = joblib.dump(dtree_model, filename, compress=0)
